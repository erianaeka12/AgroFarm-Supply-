...
def statuspembelian():
    ...
    if os.path.exists(file_pending):
        ...
        if not user_pending.empty:
            ...
            print(tabulate(user_pending, headers='keys', tablefmt='fancy_grid', showindex=False))
    ...
    if os.path.exists(file_selesai):
        ...
        if not user_selesai.empty:
            ...
            print(tabulate(user_selesai, headers='keys', tablefmt='fancy_grid', showindex=False))
...
def riwayatpembelian():
    ...
    print(tabulate(user_history, headers='keys', tablefmt='fancy_grid', showindex=False))
    input("Klik Enter untuk kembali...")
    menucustomer()
